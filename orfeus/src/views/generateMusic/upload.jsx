...
function Upload() {
  ...
  return (
    <div>
      <form className={generate_styles.upload_form} onSubmit={handleSubmit}>
        <div className={generate_styles.sample_div}>
          <h1 className={generate_styles.sample_title}>Sample File Upload</h1>
          <label>Audio Sample (.wav)</label>
          <input type="file" onChange={handleChange} />
        </div>
        <div className={generate_styles.filename_div}>
          <label className={generate_styles.filename_label}>
            Output Audio Name:{' '}
          </label>
          <input type="text" placeholder="filename" onChange={updateInput} />
        </div>
        <div className={generate_styles.genre_div}>
          <label
            className={generate_styles.genre_label}
            style={{ color: 'white' }}
          >
            Genre
          </label>
